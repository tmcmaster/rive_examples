...
import 'package:rive_examples/teddy/input_helper.dart';
...
class TrackingTextInput extends StatefulWidget {
  TrackingTextInput({Key? key, this.onCaretMoved, this.onTextChanged, this.hint, this.label, this.isObscured = false})
      : super(key: key);
