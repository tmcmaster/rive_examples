...
class FavouriteIconDemo extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _ButtonsState();
}

class _ButtonsState extends State<FavouriteIconDemo> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: <Widget>[
          Row(children: [
            Container(margin: EdgeInsets.only(right: 10), child: Icon(Icons.rate_review, size: containerSize + 2)),
            Text(
              "Reviews",
          ...
          GestureDetector(
            ...
            child: Row(children: [
              Container(
                  ...
                  child: FlareActor('assets/rive/Favorite.flr',
                      shouldClip: false,
          ...
          Row(children: [
            Container(margin: EdgeInsets.only(right: 10), child: Icon(Icons.share, size: containerSize + 2)),
            Text(
              "Share",
              style: TextStyle(fontSize: 11, fontFamily: "Montserrat", color: Colors.black45),
            ),
