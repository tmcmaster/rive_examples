...
class ResizingHouseDemo extends StatefulWidget {
  ResizingHouseDemo({Key? key}) : super(key: key);

  @override
  _ResizingHouseDemoState createState() => _ResizingHouseDemoState();
}

class _ResizingHouseDemoState extends State<ResizingHouseDemo> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Stack(fit: StackFit.expand, children: [
        FlareActor(
          'assets/rive/Resizing_House.flr',
            ...
            child: Column(
              ...
              children: [
                Text(_houseController.rooms.toString() + " ROOMS",
                    style: TextStyle(
                        color: Colors.white, fontFamily: "Roboto", fontSize: 14, fontWeight: FontWeight.w700)),
                Slider(
                    min: 0,
                    max: 3,
                    divisions: 3,
