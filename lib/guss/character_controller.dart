...
class CharacterController extends FlareControls {
  ...
  bool advance(FlutterActorArtboard artboard, double elapsed) {
    ...
    Vec2D frameTranslation =
        Vec2D.add(Vec2D(), _faceControl!.translation, Vec2D.scale(diff, diff, min(1.0, elapsed * 5.0)));
  ...
  void initialize(FlutterActorArtboard artboard) {
    ...
    _coverEyesIn = ["cover_eyes_in", "hands_up"]
        .firstWhere((String name) => artboard.getAnimation(name) != null, orElse: () => '');
    _coverEyesOut = ["cover_eyes_out", "hands_down"]
        .firstWhere((String name) => artboard.getAnimation(name) != null, orElse: () => '');
